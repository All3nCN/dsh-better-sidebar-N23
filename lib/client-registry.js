	...
	factory: (require) => {
		...
		* entirely — re-enabling them is the settings page's job. */
		...
		function Sidebar(props) {
			...
			* variables remain unchanged until pointer-up, avoiding transcript reflow. */
